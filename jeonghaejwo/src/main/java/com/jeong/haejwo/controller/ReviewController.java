...
public class ReviewController {
	...
	public @ResponseBody Map<String, Object> addComment(@RequestParam Map<String, Object> data, Map<String, Object> map, HttpSession hs) {
		int result= reService.insert(data);
		if(result==1) {
	...
	@RequestMapping("/list")
	public @ResponseBody List<Object> getList(@RequestParam Map<String, Object> data, Map<String, Object> map, HttpSession hs){
