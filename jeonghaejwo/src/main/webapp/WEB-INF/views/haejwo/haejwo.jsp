	...
	<div class='jhj_container'>
		...
		<div class='input_container'>
			<div class='user_setting'>
				...
				<!-- 목적지 선택 박스 -->
				<div id="network-popUp" class="destination_selectBox"
					style="display: block;">
					<div
			...
			<div class="funkyradio">
				<div class="funkyradio-info">
					<input type="radio" name="radio" id="radio1" disabled=true
						value=0.4 data-value='1000' /> <label for="radio1">반경 1km
						내에서</label>
				</div>
				<div class="funkyradio-primary">
					<input type="radio" name="radio" id="radio2" disabled=true
						value=0.4 data-value='3000' /> <label for="radio2">반경 3km
						내에서</label>
				</div>
				<div class="funkyradio-success">
					<input type="radio" name="radio" id="radio3" disabled=true
						value=1.1 data-value='5000' /> <label for="radio3">반경 5km
						내에서</label>
				</div>
